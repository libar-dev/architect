...
The first option was used organically in new-convex-es before code stubs had a proper home. The learning from code stubs — design artifacts must live outside compiled/linted/executed paths — applies equally to step definition stubs.
