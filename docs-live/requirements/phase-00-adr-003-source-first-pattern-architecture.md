...
**Purpose:** Detailed requirements for the ADR 003 Source First Pattern Architecture feature
...
_Verified by: TypeScript source is canonical pattern definition_

## Deliverables

- Decision spec (in-progress)
- Update CLAUDE.md annotation ownership (pending)
- Update monorepo source-annotations.md (pending)
- Reframe tag-duplication anti-pattern (pending)
