...
**Purpose:** Detailed requirements for the ADR 005 Configurable Tag Prefix feature
...
- tagPrefix option in factory (complete)
- fileOptInTag option in factory (complete)
- Generic preset (complete)
- DDD-ES-CQRS preset (complete)
