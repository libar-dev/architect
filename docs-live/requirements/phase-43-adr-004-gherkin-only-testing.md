# ✅ ADR 004 Gherkin Only Testing

**Purpose:** Detailed requirements for the ADR 004 Gherkin Only Testing feature
...
**at-libar-docs-usecase "When handling command failures"**
...
| Bold/emphasis | **bold** and _italic_        | Yes              |
...
_Verified by: at-libar-docs-usecase "When handling command failures"_
...
| --------------- | ---------------------------------------------------------------------------------- | --------------------- |
| lint:patterns   | lint-patterns -i 'src/\*_/_.ts'                                                    | Annotation quality    |
...
| Step Name         | Command                                                                                |
| ----------------- | -------------------------------------------------------------------------------------- |
| Lint annotations  | npx lint-patterns -i "src/\*_/_.ts" --strict                                           |
...
_Verified by: Gherkin-only policy enforced_

## Deliverables

- Policy definition in CLAUDE.md (complete)
- Test migration manifest (superseded)
