...
- ReferenceDocConfig interface (complete)
- createReferenceCodec factory (complete)
- Convention section builder (complete)
- Shape section builder (AD-6) (complete)
- Behavior section builder (complete)
- AD-5 composition order (complete)
- 13 reference configs (complete)
- ReferenceDocGenerator class (complete)
- ReferenceDocsGenerator meta-generator (complete)
- Convention extractor (complete)
