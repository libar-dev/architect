...
- **Process State Types**: :PatternGraph Type definitions for the PatternGraphAPI query interface.
...
- **Process API CLI Impl**: Exposes PatternGraphAPI methods as CLI subcommands with JSON output.
...
- **MCP Server Integration**: Claude Code accesses PatternGraphAPI through subprocess calls to the process-api CLI.
