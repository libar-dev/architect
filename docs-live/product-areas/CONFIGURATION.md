...
[View DEFAULT_WORKFLOW_CONFIG — Inline Default Workflow Constant source](delivery-process/stubs/config-based-workflow-definition/default-workflow-config.ts)
