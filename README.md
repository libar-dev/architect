...
├── architect/                    # dogfood specs, decisions, stubs, step-stubs, slices, ideations, design-reviews
├── docs/                         # manual documentation (being superseded by docs-live/)
├── docs-live/                    # generated by `pnpm docs:all`; git-tracked (determinism-gate diff target)
