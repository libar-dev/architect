...
@libar-docs-pattern:ADR011PublishingStrategy
@libar-docs-phase:99
@libar-docs-status:roadmap
@libar-docs-product-area:DeliveryProcess
@libar-docs-claude-md-section:publishing
@libar-docs-convention:publishing
Feature: ADR-011 - Publishing Strategy and Workflow
  ...
  **Consequences:**
  ...
  Background: Deliverables
    Given the following deliverables:
      ...
      | Publishing strategy decision | complete | delivery-process/decisions/adr-011-publishing-strategy.feature |
  ...
  @acceptance-criteria
  Scenario: ADR generates Publishing Reference documentation
