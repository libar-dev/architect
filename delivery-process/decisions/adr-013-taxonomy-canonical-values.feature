...
@libar-docs-pattern:ADR013TaxonomyCanonicalValues
@libar-docs-status:roadmap
@libar-docs-product-area:DeliveryProcess
@libar-docs-convention:annotation-system
Feature: ADR-013 - Taxonomy Canonical Values
  ...
  **Consequences:**
  ...
  Background: Deliverables
    Given the following deliverables:
      ...
      | Decision spec | in-progress | delivery-process/decisions/adr-013 |
      ...
      | Audit unused taxonomy tags | pending | src/taxonomy/registry-builder.ts |
  ...
  Rule: Migration mapping from current values
  ...
  Rule: Unused taxonomy tags (TODO)
