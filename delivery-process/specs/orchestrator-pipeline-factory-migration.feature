...
@libar-docs-business-value:eliminate-last-parallel-pipeline-and-unify-pipeline-definition
  ...
  **What does NOT change:**
  ...
  Rule: Orchestrator delegates pipeline to factory
    ...
    **Verified by:** No pipeline imports in orchestrator, Factory is sole pipeline definition
    ...
    @acceptance-criteria
    Scenario: No pipeline imports in orchestrator
  ...
  Rule: mergePatterns lives in pipeline module
    ...
    **Verified by:** mergePatterns location, Public API preserved
    ...
    @acceptance-criteria
    Scenario: mergePatterns location
  ...
  Rule: Factory provides structured warnings for all consumers
    ...
    **Verified by:** Orchestrator warnings preserved, Existing consumers unaffected
    ...
    @acceptance-criteria
    Scenario: Orchestrator warnings preserved
