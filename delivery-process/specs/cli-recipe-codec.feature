@libar-docs
@libar-docs-pattern:CliRecipeCodec
@libar-docs-status:completed
@libar-docs-unlock-reason:Initial-commit-with-all-deliverables-complete
@libar-docs-phase:35
@libar-docs-effort:2w
@libar-docs-product-area:Generation
@libar-docs-depends-on:DocsConsolidationStrategy
@libar-docs-depends-on:ProcessApiHybridGeneration
@libar-docs-business-value:replaces-460-lines-of-manual-PROCESS-API-md-prose-with-generated-recipe-and-narrative-content
...
Feature: CLI Recipe Codec
  ...
  **Design Session Findings (2026-03-06):**
  ...
  | DD-3: Preamble mechanism proven by ReferenceDocConfig and ErrorGuideCodec stubs | Why Use This (30 lines), Quick Start (32 lines), Session Types (12 lines) are editorial judgment | Generator accepts preamble SectionBlock[] via CliRecipeGeneratorConfig, configured in delivery-process.config.ts |
  ...
  **Design Stubs:**
  ...
  | Recipe schema types | delivery-process/stubs/cli-recipe-codec/recipe-schema.ts | DD-1 RecipeGroup/RecipeExample/RecipeStep, DD-4 CommandNarrative/CommandNarrativeGroup, CLISchema extension |
  | Generator class | delivery-process/stubs/cli-recipe-codec/cli-recipe-generator.ts | DD-1 separate generator, DD-3 preamble config, DD-5 no claude-md output |
  | Recipe data examples | delivery-process/stubs/cli-recipe-codec/recipe-data.ts | DD-2 schema data mapping, DD-4 narrative examples, preamble content examples |
  ...
  Background: Deliverables
    Given the following deliverables:
      ...
      | Preamble content for Why Use This and session decision tree | complete | delivery-process.config.ts | No | n/a |
  ...
  Rule: Narrative prose uses preamble mechanism
    ...
    **Invariant:** Editorial content that cannot be derived from the CLI schema --
    ...
    `delivery-process.config.ts` as structured section data and appears before all
