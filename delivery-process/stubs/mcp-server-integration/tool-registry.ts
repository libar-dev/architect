 ...
 * @libar-docs-target src/mcp/tool-registry.ts
 ...
 * Each tool has a dp_ prefix, a Zod input schema for parameter validation,
 ...
 *
 * DD-5: dp_ prefix per spec invariant - avoids collision with other MCP servers
