@libar-docs
@libar-docs-pattern:IndexReference
@libar-docs-status:roadmap
@libar-docs-phase:99
@libar-docs-core
@libar-docs-claude-md-section:index
Feature: Index Reference - Auto-Generated Documentation

  **Problem:**
  Developers and AI agents need a navigation index to find the right documentation.
  The documentation index must cover package metadata, reading order by audience,
  quick navigation, and key concepts. Maintaining this manually leads to drift.

  **Solution:**
  Auto-generate the documentation index from this decision document.
  Tables for navigation, reading order, and document roles are defined as Rule blocks.
  Key concepts (FSM, ProcessStateAPI) are embedded as reference content.

  **Target Documents:**

| Output | Purpose | Detail Level |
| docs-generated/docs/INDEXREFERENCE.md | Detailed human reference | detailed |
| docs-generated/_claude-md/index/indexreference.md | Compact AI context | summary |
...
| Document Contents Summary | THIS DECISION (Rule: Document Contents Summary) | Rule block table |
...
| PUBLISHING.md | Maintainers | Release - npm publishing |
  ...
  @acceptance-criteria
  Scenario: Reference generates Index documentation
    Given this decision document with source mapping table
    When running doc-from-decision generator
    Then detailed docs are generated with all navigation tables
    And compact docs are generated with essential reference
    And FSM diagram is included as Mermaid code block
    And ProcessStateAPI example is included
    And document roles summary is present
