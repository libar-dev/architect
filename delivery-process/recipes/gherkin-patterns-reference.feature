@libar-docs
@libar-docs-pattern:GherkinPatternsReference
@libar-docs-status:roadmap
@libar-docs-phase:99
@libar-docs-core
@libar-docs-claude-md-section:gherkin
Feature: Gherkin Patterns Reference - Auto-Generated Documentation
...
| Background deliverables | Tracks implementation progress | DataTable with Status column |
  ...
  Rule: Rule Blocks for Business Constraints
...
| **Verified by:** | Comma-separated scenario names | Traceability generator |
  ...
  Rule: Scenario Outline for Variations
...
| Same behavior, different data | Use Scenario Outline |
  ...
  Rule: DataTable and DocString Usage
...
| at-libar-docs-phase:N | Timeline phase | Phase number for roadmap |
  ...
  Rule: Feature Description Patterns
...
| at-libar-docs-pattern:My Pattern | at-libar-docs-pattern:MyPattern |
    ...
    **Quoted Values:**
    ...
    Example: at-libar-docs-usecase "When handling command failures"
...
| METHODOLOGY.md | Core thesis and two-tier architecture |
  ...
  @acceptance-criteria
  Scenario: Reference generates Gherkin Patterns documentation
    Given this decision document with source mapping table
    When running doc-from-decision generator
    Then detailed docs are generated with roadmap spec structure
    And detailed docs are generated with tag conventions table
    And detailed docs are generated with feature description patterns
    And detailed docs are generated with valid rich content table
    And compact docs are generated with quick reference table
    And DataTable and DocString usage is documented
