@libar-docs
@libar-docs-pattern:PublishingReference
@libar-docs-status:roadmap
@libar-docs-phase:99
@libar-docs-core
@libar-docs-claude-md-section:publishing
Feature: Publishing Reference - Auto-Generated Documentation
...
| PROCESS-GUARD-REFERENCE.md | Reference | Pre-commit hooks validation |
  ...
  Scenario: Reference generates Publishing documentation
    ...
    Then detailed docs are generated with version strategy table
    And detailed docs are generated with publishing workflow commands
    And detailed docs are generated with git hooks documentation
    And compact docs are generated with troubleshooting table
    And all bash commands are properly formatted
