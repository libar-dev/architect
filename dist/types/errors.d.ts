...
export type ExtractionError = PatternValidationError | DirectiveValidationError | ProcessMetadataValidationError | DeliverableValidationError | GherkinPatternValidationError;
 ...
 * ```
 */
export declare function createFileParseError(file: string, reason: string, location?: {
    line: number;
    column: number;
}, originalError?: unknown): FileParseError;
/**
 ...
 * ```
 */
export declare function createDirectiveValidationError(file: string, line: number, reason: string, directive?: string): DirectiveValidationError;
/**
 ...
 * ```
 */
export declare function createPatternValidationError(file: SourceFilePath, patternName: string, reason: string, validationErrors?: string[]): PatternValidationError;
/**
 ...
 * ```
 */
export declare function createFeatureParseError(file: string, reason: string, originalError?: unknown): FeatureParseError;
/**
 ...
 * ```
 */
export declare function createProcessMetadataValidationError(file: string, reason: string, validationErrors?: readonly string[]): ProcessMetadataValidationError;
/**
 ...
 * ```
 */
export declare function createDeliverableValidationError(file: string, reason: string, deliverableName?: string, validationErrors?: readonly string[]): DeliverableValidationError;
/**
 ...
 * ```
 */
export declare function createGherkinPatternValidationError(file: string, patternName: string, reason: string, validationErrors?: readonly string[]): GherkinPatternValidationError;
