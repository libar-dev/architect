 ...
 * - n/a: Not applicable
 */
export declare const DELIVERABLE_STATUS_VALUES: readonly ["complete", "in-progress", "pending", "deferred", "superseded", "n/a"];
export type DeliverableStatus = (typeof DELIVERABLE_STATUS_VALUES)[number];
/**
 * Default status for new deliverables
 */
export declare const DEFAULT_DELIVERABLE_STATUS: DeliverableStatus;
/**
 * Pre-built set of valid deliverable statuses for O(1) membership checks.
 */
export declare const VALID_DELIVERABLE_STATUS_SET: ReadonlySet<string>;
/**
 ...
 */
export declare function isDeliverableStatusComplete(status: DeliverableStatus): boolean;
/**
 ...
 * from `normalized-status.ts` instead.
 */
export declare function isDeliverableStatusInProgress(status: DeliverableStatus): boolean;
/**
 ...
 */
export declare function getDeliverableStatusEmoji(status: DeliverableStatus): string;
//# sourceMappingURL=deliverable-status.d.ts.map