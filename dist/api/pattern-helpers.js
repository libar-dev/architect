 ...
 */
export function getRelationships(dataset, name) {
    if (dataset.relationshipIndex === undefined)
        return undefined;
 ...
 */
export function allPatternNames(dataset) {
 ...
 */
export function suggestPattern(query, candidates) {
