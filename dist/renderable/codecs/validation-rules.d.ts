 ...
 */
export declare const DEFAULT_VALIDATION_RULES_OPTIONS: Required<ValidationRulesCodecOptions>;
/**
 ...
 * ```
 */
export declare function createValidationRulesCodec(options?: ValidationRulesCodecOptions): z.ZodCodec<typeof MasterDatasetSchema, typeof RenderableDocumentOutputSchema>;
/**
 ...
 * ```
 */
export declare const ValidationRulesCodec: z.ZodCodec<z.ZodObject<{
