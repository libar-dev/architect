 ...
 * ```
 */
export declare function normalizeImplPath(filePath: string): string;
/**
 * Options for PatternsDocumentCodec
 */
export interface PatternsCodecOptions extends BaseCodecOptions {
    /** Include dependency graph visualization (default: true) */
    includeDependencyGraph?: boolean;
    /** Include use cases section (default: true) */
    includeUseCases?: boolean;
    /** Filter by categories (default: all categories) */
    filterCategories?: string[];
}
/**
 * Default options for PatternsDocumentCodec
 */
export declare const DEFAULT_PATTERNS_OPTIONS: Required<PatternsCodecOptions>;
 ...
 * ```
 */
export declare function createPatternsCodec(options?: PatternsCodecOptions): z.ZodCodec<typeof MasterDatasetSchema, typeof RenderableDocumentOutputSchema>;
/**
 ...
 * ```
 */
export declare const PatternsDocumentCodec: z.ZodCodec<z.ZodObject<{
