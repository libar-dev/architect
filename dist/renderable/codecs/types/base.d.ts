 ...
 */
export declare const DEFAULT_LIMITS: Required<CodecLimits>;
/**
 * Default base options
 */
export declare const DEFAULT_BASE_OPTIONS: Required<BaseCodecOptions>;
/**
 * Merge user options with defaults
 */
export declare function mergeOptions<T extends BaseCodecOptions>(defaults: Required<T>, options?: T): Required<T>;
/**
 ...
 */
export type DocumentCodec = z.ZodCodec<typeof MasterDatasetSchema, typeof RenderableDocumentOutputSchema>;
