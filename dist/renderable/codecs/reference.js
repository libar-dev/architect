...
export const PRODUCT_AREA_META = {
    ...
    Configuration: {
        ...
        intro: 'Configuration controls what gets scanned, which tags are recognized, and how output is organized. ' +
    ...
    CoreTypes: {
        ...
        intro: 'Foundation types used across all other areas. The Result monad replaces try/catch ' +
