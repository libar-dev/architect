    ...
    if (inOutlineBlock) {
      ...
      if (paramMatch !== null) {
        ...
        violations.push({
          ...
          message: `Step callback inside ScenarioOutline uses function param "${paramName}" — use variables object instead (ScenarioOutline started at line ${String(outlineStartLine)})`,
          file: stepFilePath,
          line: i + 1,
        });
      }
