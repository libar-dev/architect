 ...
 *
 * Defines the `OverviewDigest` fragment shape for delivery progress, blocking patterns, a "start here" orientation block (high-signal docs + safe-to-start items), the role distribution, a high-level architecture glimpse, a generated-views index, and CLI hints.
 */
import { z } from 'zod';
...
/**
 * Fragment shape for the delivery overview — progress totals, blocking
 * patterns, an optional "start here" orientation block (orientation doc
 * references + the safe-to-start roadmap set), an optional role distribution,
 * an optional high-level architecture glimpse, an optional generated-views
 * index, and optional CLI hints.
 *
 * @architect-shape
 */
