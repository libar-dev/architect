/**
 * Error Factory Step Definitions for architect-core
 *
...
describeFeature(feature, ({ Rule, Background, AfterEachScenario }) => {
    ...
    ({ RuleScenario, RuleScenarioOutline }) => {
      RuleScenarioOutline(
        ...
        ({ When, Then, And }, variables) => {
          const { file, reason, expected_text } = variables as {
            file: string;
            reason: string;
          ...
          And('the error file should be {string}', () => {
            expect((state!.error as FileSystemError).file).toBe(file);
          });

          And('the error reason should be {string}', () => {
            expect((state!.error as FileSystemError).reason).toBe(reason);
          });
      ...
      RuleScenario(
        ...
        ({ When, Then, And }) => {
          ...
          And(
            'the originalError message should contain {string}',
  ...
  // ===========================================================================
  // Rule: createDirectiveValidationError
  // ===========================================================================
  ...
  // ===========================================================================
  // Rule: createPatternValidationError
  // ===========================================================================
    ...
    ({ RuleScenario }) => {
      RuleScenario(
        ...
        ({ When, Then, And }) => {
          ...
          And(
            'the error message should contain all of:',
  ...
  // ===========================================================================
  // Rule: createProcessMetadataValidationError
  // ===========================================================================
  ...
  // ===========================================================================
  // Rule: createDeliverableValidationError
  // ===========================================================================
