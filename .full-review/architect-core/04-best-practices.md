...
The reports converge on a clear claim: the package's *idioms* are right; the *application of those idioms* is uneven; and the *automation that would enforce uniformity* doesn't exist.
