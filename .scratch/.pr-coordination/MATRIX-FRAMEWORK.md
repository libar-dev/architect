...
**Progressive disclosure (3-axis INPUT/OUTPUT/INDEX from DECISIONS.md D2) operates _inside_ a chosen cell, not as a fourth axis.** This is the PM fork's sharpest clarification.
...
3. **Decision on whether a 5th capability spec is needed** for the matrix substrate (recommendation in earlier conversation: NO; matrix is the _answer_, not an _invariant_).
