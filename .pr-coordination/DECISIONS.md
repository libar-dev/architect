...
- **Status:** resolved (value-transfer doctrine + verified against the live graph, 2026-05-25) → filter test-feature patterns from the component view by source path; tag only production code; never use `implementsPatterns` as a test discriminator.
