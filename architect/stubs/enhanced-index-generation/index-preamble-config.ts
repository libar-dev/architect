 ...
 * @architect-target architect.config.ts
 *
 ...
 * time. A future `@architect-glossary` annotation type could solve this, but
 ...
 * ### Config Integration
 *
 * This preamble is provided via `CodecOptions` in architect.config.ts:
 *
 * ```typescript
 * // In architect.config.ts (future)
...
export const QUICK_NAVIGATION_SECTIONS: readonly SectionBlock[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      ['Query process state via CLI', '[CLI.md](docs/CLI.md)'],
...
export const READING_ORDER_SECTIONS: readonly SectionBlock[] = [
  ...
  },
  {
    ...
    text: [
      ...
      '5. **[CLI.md](docs/CLI.md)** -- Data API CLI query interface',
