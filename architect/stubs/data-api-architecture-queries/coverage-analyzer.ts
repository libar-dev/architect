...
export interface CoverageReport {
  /** Count of files with @architect opt-in that produced patterns. */
  ...
  /** Files matching input globs but lacking @architect marker. */
 ...
 * @returns Relative paths of files without @architect marker
 */
