 ...
 * @architect-uses ContextAssembler
 * @architect-used-by PatternGraphCLIImpl
 * @architect-target src/api/context-formatter.ts
 ...
 *     Spec: architect/specs/agent-llm-integration.feature
 *
 *     === STUBS ===
 *     stubs/agent-llm/adapter.ts -> src/agent/adapter.ts
 *
 *     === DEPENDENCIES ===
 *     [completed] AgentBCIsolation (22a) architect/specs/...
 ...
 *
 *     === PRIMARY ===
 *     architect/specs/order-saga.feature
 *     architect/stubs/order-saga/saga.ts
 *
 *     === COMPLETED DEPENDENCIES ===
 *     src/events/event-store.ts
 *
 *     === ROADMAP DEPENDENCIES ===
 *     architect/specs/saga-engine.feature
 *
