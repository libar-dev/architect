 ...
 * @architect-target src/generators/built-in/cli-recipe-generator.ts
 *
...
export interface CliRecipeGeneratorConfig {
   ...
   * Configured in architect.config.ts.
   */
 ...
 *
 * Called from architect.config.ts or generator registration.
