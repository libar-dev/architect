 ...
 * implemented. This content cannot come from `@architect-convention`
...
// ---------------------------------------------------------------------------
// Example ReferenceDocConfig entry (would be added to architect.config.ts)
// ---------------------------------------------------------------------------

/**
 * This stub demonstrates the config entry shape. The actual entry goes in
 * `architect.config.ts` under the `referenceDocConfigs` array.
 *
