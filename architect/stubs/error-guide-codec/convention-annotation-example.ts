 ...
 * @architect-implements ErrorGuideCodec
 * @architect-target src/lint/process-guard/decider.ts
 *
 ...
 * - `src/generators/orchestrator.ts` with `@architect-convention pipeline-architecture`
 * - `src/renderable/codecs/reference.ts` with `@architect-convention codec-registry`
 * - `src/renderable/codecs/validation-rules.ts` with `@architect-convention codec-registry`
 *
 ...
 *
 * Specifically, `@architect-convention process-guard-errors` is added
