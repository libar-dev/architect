    ...
    **Verified by:** Query implementations for pattern, Query implemented patterns for file
    ...
    Scenario: Query implementations for a pattern
      ...
      And files implement this pattern:
        | File | Via Tag |
        | src/lint/process-guard/decider.ts | @architect-implements:ProcessGuardLinter |
        | src/lint/process-guard/derive-state.ts | @architect-implements:ProcessGuardLinter |
    ...
    Scenario: Query implemented patterns for a file
      Given a file "decider.ts" with tag "@architect-implements:ProcessGuardLinter, ProcessGuardDecider"
