@architect
@architect-pattern:PublishingRelocation
@architect-status:completed
@architect-phase:40
@architect-effort:0.25d
@architect-product-area:Generation
@architect-depends-on:DocsConsolidationStrategy
@architect-business-value:move-maintainer-only-npm-and-ci-publishing-procedures-to-correct-repo-root-audience
