@architect
@architect-pattern:ClaudeModuleGeneration
@architect-status:completed
@architect-unlock-reason:Skip-Feature-description-in-module-output
@architect-phase:25
@architect-effort:1.5d
@architect-product-area:Generation
@architect-business-value:automated-claude-md-modules-from-source
@architect-priority:high
@architect-executable-specs:tests/features/behavior/claude-modules
Feature: CLAUDE.md Module Generation from Source Annotations
  ...
  **Solution:** Generate CLAUDE.md modules directly from behavior spec feature files using
  ...
  - `@architect-claude-module` - Module identifier (becomes filename)
  - `@architect-claude-section` - Target section directory in `_claude-md/`
  - `@architect-claude-tags` - Tags for variation filtering in modular-claude-md
  ...
  **Prototype Example:**
  ...
  generates both `_claude-md/architect/process-guard.md` and detailed docs.
  ...
  Rule: Gherkin parser extracts claude module tags from feature files
    ...
    **Verified by:** Extract claude-module from feature tags, Extract claude-section
    ...
    Scenario: Extract claude-section from feature tags
      Given a feature file with tags:
        """gherkin
        @architect-claude-module:fsm-validator
        @architect-claude-section:testing
  ...
  Rule: Claude module generator writes files to correct locations
    ...
    **Verified by:** Output path uses section as directory, Output filename uses module name,
    ...
    Scenario: Multiple modules generated from single run
      ...
      And "_claude-md/architect/process-guard.md" should exist
