...
**Format reference:** `formal-spec/08-spec-evolution.md` § "Level 1: Candidate Spec" and § "Promotion: Idea → Candidate". The plugin-internal canonical form lives in [`../../../.agents/skills/architect-base/references/four-tier-ladder.md`](../../../.agents/skills/architect-base/references/four-tier-ladder.md).
