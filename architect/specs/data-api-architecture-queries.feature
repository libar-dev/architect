...
@architect-business-value:deep-architecture-exploration-for-design-sessions
Feature: Data API Architecture Queries - Deep Architecture Exploration
  ...
  **Business Value:**
  ...
  Rule: Arch subcommand provides neighborhood and comparison views
  ...
  Rule: Tags and sources commands provide taxonomy and inventory views
