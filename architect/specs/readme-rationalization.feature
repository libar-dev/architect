...
@architect-business-value:focused-npm-landing-page
...
Feature: README Rationalization
  ...
  **Why It Matters:**
  ...
  | Better getting-started page | Trimmed README aligns with /architect/getting-started/ URL |
  ...
  **README-to-Website Component Mapping:**
  ...
  Background: Deliverables
    Given the following deliverables:
      ...
      | Document README-to-website component mapping for extracted enterprise sections | complete | architect/specs/readme-rationalization.feature | No | n/a |
  ...
  Rule: Trimmed README must serve as an effective getting-started page
    ...
    **Invariant:** The website publishes README.md as /architect/getting-started/ via
    ...
    **Verified by:** Trimmed README has install instructions within first 20 lines and links to all guide documents
    ...
    Scenario: Trimmed README has install instructions within first 20 lines and links to all guide documents
      Given the website publishes README.md as /architect/getting-started/
      When the rationalization is complete
