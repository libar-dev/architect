@architect
@architect-pattern:ProceduralGuideCodec
@architect-status:completed
@architect-unlock-reason:DD7-DD8-preamble-migration-complete
@architect-phase:35
@architect-effort:3w
@architect-product-area:Generation
@architect-depends-on:DocsConsolidationStrategy
@architect-business-value:replaces-757-lines-of-manual-SESSION-GUIDES-and-ANNOTATION-GUIDE-with-generated-procedural-guides-using-dual-source-codec
...
Feature: Procedural Guide Codec
  ...
  **Design Session Findings (2026-03-06):**
  ...
  | DD-1: No new codec class needed -- reuse createReferenceCodec() with two ReferenceDocConfig entries | Eliminates codec implementation deliverable; reduces to config-only work | Two ReferenceDocConfig entries in architect.config.ts with different preamble, includeTags, and output paths |
  ...
  **Design Stubs:**
  | Stub | Purpose | Target |
  | architect/stubs/procedural-guide-codec/procedural-codec-options.ts | Documents DD-1,DD-3,DD-4: no new options type, reuses ReferenceDocConfig | src/renderable/codecs/procedural-guide.ts |
  | architect/stubs/procedural-guide-codec/procedural-codec.ts | Documents DD-1,DD-2,DD-5,DD-6,DD-7,DD-8: config entries with loadPreambleFromMarkdown() | architect.config.ts |
  | architect/stubs/procedural-guide-codec/session-guide-preamble.ts | DD-7: Markdown source file example + loadPreambleFromMarkdown() usage | architect.config.ts |
  | architect/stubs/procedural-guide-codec/annotation-guide-preamble.ts | DD-7: Markdown source file example + loadPreambleFromMarkdown() usage | architect.config.ts |
  | architect/stubs/procedural-guide-codec/load-preamble.ts | DD-8: loadPreambleFromMarkdown() utility interface and parsing spec | src/renderable/load-preamble.ts |
  ...
  Background: Deliverables
    Given the following deliverables:
      ...
      | Migrate session workflow preamble to loadPreambleFromMarkdown() call (DD-7) | complete | architect.config.ts | Yes | integration |
      | Migrate annotation guide preamble to loadPreambleFromMarkdown() call (DD-7) | complete | architect.config.ts | Yes | integration |
