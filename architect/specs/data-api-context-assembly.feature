...
@architect-unlock-reason:Fix-deliverable-gate-description-preservation-tag-parsing
@architect-phase:25b
@architect-product-area:DataAPI
@architect-effort:3d
@architect-priority:high
@architect-depends-on:DataAPIOutputShaping,DataAPIStubIntegration
@architect-business-value:replace-explore-agents-with-one-command
Feature: Data API Context Assembly - One-Command Session Context
  ...
  **Business Value:**
  ...
  Rule: Context command assembles curated context for a single pattern
  ...
  Rule: Files command returns only file paths organized by relevance
  ...
  Rule: Dep-tree command shows recursive dependency chain with status
  ...
  Rule: Context command supports multiple patterns with merged output
  ...
  Rule: Overview provides executive project summary
