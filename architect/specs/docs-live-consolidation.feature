@architect
@architect-pattern:DocsLiveConsolidation
@architect-status:completed
@architect-phase:37
@architect-effort:0.5d
@architect-product-area:Generation
@architect-depends-on:DocsConsolidationStrategy
@architect-business-value:single-output-directory-for-all-website-published-and-claude-readable-content
@architect-priority:high
@architect-unlock-reason:Move-business-rules-taxonomy-to-docs-live
Feature: Docs Live Directory Consolidation
  ...
  **Solution:**
  ...
  output directory configs in `architect.config.ts`.
  ...
  **Why It Matters:**
  ...
  Background: Deliverables
    Given the following deliverables:
      ...
      | Reference docs output → docs-live/reference/ | complete | architect.config.ts | Yes | integration |
      | Architecture _claude-md/ → docs-live/_claude-md/architecture/ | complete | architect.config.ts | Yes | integration |
      | Remove root-level compact duplicates from docs-generated/ | complete | architect.config.ts | No | n/a |
