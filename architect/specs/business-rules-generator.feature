@architect
@architect-pattern:BusinessRulesGenerator
  ...
  **Why It Matters:**
  ...
  Background: Deliverables
    Given the following deliverables:
      ...
      | Business rules extractor | pending | @libar-dev/architect/src/generators/business-rules/ | Yes | unit |
      | Business rules renderer | pending | @libar-dev/architect/src/generators/business-rules/ | Yes | unit |
      | CLI integration | pending | @libar-dev/architect/src/cli/generate-docs.ts | Yes | unit |
      | docs:business-rules script | pending | package.json | No | - |
  ...
  Rule: Organizes rules by domain category and phase
    ...
    **Invariant:** Rules are grouped first by domain category (from `@architect-*` flags),
    ...
    **Verified by:** Groups rules by domain, Orders by phase within domain
    ...
    Scenario: Groups rules by domain category
      Given feature files with these domain tags:
        ...
        | reservation-pattern.feature | @architect-ddd | Reservations prevent race conditions |
        | event-store.feature | @architect-event-sourcing | Events are immutable |
        | projection-categories.feature | @architect-cqrs | Projections must declare category |
      When the business rules generator runs
