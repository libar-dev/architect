...
@architect-unlock-reason:Fix-code-fence-formatting-per-PR-review
@architect-phase:26
@architect-effort:2d
@architect-product-area:Annotation
@architect-enables:DocGenerationProofOfConcept
@architect-business-value:eliminates-type-duplication-in-documentation
...
Feature: TypeScript Shape Extraction for Documentation
  ...
  **Solution:**
  New tag `@architect-extract-shapes` lists type names to extract from the same file.
  ...
  **Why It Matters:**
  ...
  Rule: Interfaces are extracted from TypeScript AST
    ...
    **Invariant:** When `@architect-extract-shapes` lists an interface name,
    ...
    **Rationale:** Partial extraction (missing generics, JSDoc, or extends clauses) produces incomplete API documentation that misleads consumers about a type's actual contract.
    ...
    Scenario: Extract simple interface
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes MyConfig
         */
    ...
    Scenario: Extract interface with JSDoc
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes ConfigOptions
         */
    ...
    Scenario: Extract interface with generics
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes Result
         */
    ...
    Scenario: Extract interface with extends
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes ExtendedConfig
         */
    ...
    Scenario: Non-existent shape produces warning
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes NonExistent
         */
        """
      When extracting shapes
    ...
    **Rationale:** Type aliases define domain vocabulary (status enums, branded types, utility types) that consumers need to understand API signatures; omitting them leaves gaps in generated documentation.
    ...
    Scenario: Extract union type alias
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes Status
         */
    ...
    Scenario: Extract mapped type
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes Readonly
         */
    ...
    Scenario: Extract conditional type
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes Unwrap
         */
    ...
    **Rationale:** Enum members define the closed set of valid values for a type; extracting only the enum name without its members provides no useful information to documentation consumers.
    ...
    Scenario: Extract string enum
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes Severity
         */
    ...
    Scenario: Extract const enum
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes Direction
         */
    ...
    **Rationale:** Including implementation bodies in generated documentation exposes internal logic, bloats output size, and creates a maintenance burden when internals change without API changes.
    ...
    Scenario: Extract async function signature
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes fetchData
         */
    ...
    Scenario: Extract arrow function with type annotation
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes createValidator
         */
    ...
    **Rationale:** Authors intentionally order shapes for progressive disclosure (e.g., output before input); using source order would break the author's intended documentation narrative.
    ...
    Scenario: Shapes appear in tag order
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes Output, Input, Options
         */
    ...
    Scenario: Mixed shape types in specified order
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes Status, Config, validate
         */
    ...
    **Rationale:** Resolving imports would require full dependency graph traversal across the codebase, dramatically increasing complexity and coupling the extractor to the project's module structure.
    ...
    Scenario: Shape with imported type reference
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes MyHandler
         */
    ...
    Scenario: Shape extraction does not follow imports
      Given `@architect-extract-shapes Request` where Request is imported
      When extracting shapes
    ...
    Scenario: Re-exported type produces same warning as import
      ...
      And suggestion: "Add @architect-extract-shapes to ./types.js instead"
    ...
    **Rationale:** Extracting only one overload signature hides valid call patterns from consumers, leading to incorrect usage assumptions about the function's capabilities.
    ...
    Scenario: Extract overloaded function signatures
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes validate
         */
    ...
    Scenario: Extract method overloads in interface
      Given a TypeScript file with:
        ...
        /**
         * @architect
         * @architect-extract-shapes Parser
         */
