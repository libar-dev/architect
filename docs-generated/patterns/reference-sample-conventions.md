# 📋 Reference Sample Conventions

**Purpose:** Detailed documentation for the Reference Sample Conventions pattern
...
**Both renderers produce valid output from same document**
...
**Codec pipeline produces consistent output**
...
**Convention tag routes content to reference doc**
...
_Verified by: Both renderers produce valid output from same document_
...
_Verified by: Codec pipeline produces consistent output_
...
_Verified by: Convention tag routes content to reference doc_
