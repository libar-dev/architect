...
- [`default-workflow-config.ts`](../../delivery-process/stubs/config-based-workflow-definition/default-workflow-config.ts) - ## DEFAULT_WORKFLOW_CONFIG — Inline Default Workflow Constant
