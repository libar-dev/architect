...
| 📋 Architecture Diagram Advanced | DDD | planned | Problem: Core diagram generation (see ArchitectureDiagramCore) produces component-level diagrams from `arch-*` tags. |
