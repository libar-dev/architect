...
**Purpose:** Detailed requirements for the Scoped Architectural View feature
...
- arch-view tag in taxonomy (complete)
- archView in DocDirective schema (complete)
- archView in ExtractedPattern schema (complete)
- archView extraction in AST parser (complete)
- archView propagation in doc-extractor (complete)
- byView grouping in ArchIndex (complete)
- DiagramScope interface (complete)
- collectScopePatterns filter (complete)
- collectNeighborPatterns discovery (complete)
- buildScopedDiagram builder (complete)
