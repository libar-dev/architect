...
### Manual documentation maintenance does not scale
...
### Decisions own recipes and durable content, code owns details
...
### Source mapping table parsing and extraction method dispatch
...
### Durable sources with clear ownership boundaries
...
### Design stubs live in specs, not src
