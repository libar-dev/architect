# OrchestratorPipelineFactoryMigration - Remaining Work

**Purpose:** Detailed remaining work for OrchestratorPipelineFactoryMigration
...
**Remaining:** 2 patterns (1 active, 1 planned)
...
| --- | --- | --- |
| 🚧 Orchestrator Pipeline Factory Migration | 2d | eliminate last parallel pipeline and unify pipeline definition |
...
| Pattern | Effort | Business Value |
| --- | --- | --- |
| 📋 Cli Behavior Testing | 3d | ensure cli commands work correctly with all argument combinations |
...
| Dependencies | ProcessAPILayeredExtraction |
