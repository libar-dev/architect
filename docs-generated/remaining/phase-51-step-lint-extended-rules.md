# StepLintExtendedRules - Remaining Work

**Purpose:** Detailed remaining work for StepLintExtendedRules
...
| --- | --- | --- |
| Step Lint Extended Rules | StepLintVitestCucumber | 1d |
...
| Dependencies | StepLintVitestCucumber |
