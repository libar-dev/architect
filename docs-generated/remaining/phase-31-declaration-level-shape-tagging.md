# DeclarationLevelShapeTagging - Remaining Work

**Purpose:** Detailed remaining work for DeclarationLevelShapeTagging
...
| --- | --- | --- |
| 🚧 Declaration Level Shape Tagging | 3d | enables focused shape extraction without whole file dumping |
...
| Dependencies | ShapeExtraction, ReferenceDocShowcase |
