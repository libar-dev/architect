...
**Domain constraints and invariants extracted from feature specifications. 615 rules from 129 features across 7 product areas.**
...
*[adr-005-codec-based-markdown-rendering.feature](delivery-process/decisions/adr-005-codec-based-markdown-rendering.feature)*
...
*[adr-001-taxonomy-canonical-values.feature](delivery-process/decisions/adr-001-taxonomy-canonical-values.feature)*
...
*[adr-002-gherkin-only-testing.feature](delivery-process/decisions/adr-002-gherkin-only-testing.feature)*
...
*[adr-003-source-first-pattern-architecture.feature](delivery-process/decisions/adr-003-source-first-pattern-architecture.feature)*
