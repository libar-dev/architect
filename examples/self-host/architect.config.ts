...
export default defineConfig({
  ...
  packages: [
    { id: 'architect-core', displayName: 'Architect Core', match: /^\.\.\/architect-core\// },
    {
      id: 'architect-projection',
      displayName: 'Architect Projection',
      match: /^\.\.\/architect-projection\//,
    },
    { id: 'architect-cli', displayName: 'Architect CLI', match: /^\.\.\/architect-cli\// },
    { id: 'architect-mcp', displayName: 'Architect MCP', match: /^\.\.\/architect-mcp\// },
    { id: 'architect-guard', displayName: 'Architect Guard', match: /^\.\.\/architect-guard\// },
