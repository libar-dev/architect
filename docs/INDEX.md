...
| Section               | Lines   | Key Topics                                      |
| --------------------- | ------- | ----------------------------------------------- |
| Quick Reference       | 10-56   | Role set comparison, defineConfig() examples    |
| Role Sets             | 84-151  | Default vs DDD-ES-CQRS role set details         |
...
| Available Projections      | 529-870   | Historical codec catalog; current equivalents live in `packages/architect-projection` |
...
| Data Flow Diagrams         | 1107-1290 | Pipeline flow, factory entry point, PatternGraph views                                |
| Workflow Integration       | 1292-1401 | Planning, implementing, release workflows                                             |
| Programmatic Usage         | 1403-1458 | Historical direct codec usage; current callers use projections and renderers          |
| Extending the System       | 1460-1527 | Historical custom codec/generator notes                                               |
| Quick Reference            | 1529-1604 | Codec-to-generator mapping, CLI, filters                                              |

#### Historical Codec Reference

This section points at the deprecated `ARCHITECTURE.md` catalog that predated the split
projection package. New callers should use `@libar-dev/architect-projection` entrypoints and
renderers instead.

| Historical Name       | Lines   | Former Output Files                   |
| --------------------- | ------- | ------------------------------------- |
| Patterns document     | 536-556 | PATTERNS.md, patterns/\*.md           |
| Requirements document | 557-578 | PRODUCT-REQUIREMENTS.md               |
| Roadmap document      | 581-598 | ROADMAP.md, phases/\*.md              |
| Completed milestones  | 600-607 | COMPLETED-MILESTONES.md               |
| Current work          | 609-616 | CURRENT-WORK.md                       |
| Changelog             | 618-634 | CHANGELOG.md                          |
| Session context       | 638-645 | SESSION-CONTEXT.md                    |
| Remaining work        | 647-667 | REMAINING-WORK.md                     |
| Planning checklist    | 671-675 | PLANNING-CHECKLIST.md                 |
| Session plan          | 677-681 | SESSION-PLAN.md                       |
| Session findings      | 683-696 | SESSION-FINDINGS.md                   |
| ADR document          | 700-707 | DECISIONS.md                          |
| PR changes            | 709-713 | working/PR-CHANGES.md                 |
| Traceability          | 715-719 | TRACEABILITY.md                       |
| Overview              | 721-725 | OVERVIEW.md                           |
| Business rules        | 727-749 | BUSINESS-RULES.md                     |
| Architecture document | 751-766 | ARCHITECTURE.md (generated)           |
| Taxonomy document     | 768-784 | TAXONOMY.md, taxonomy/\*.md           |
| Validation rules      | 786-804 | VALIDATION-RULES.md, validation/\*.md |
| Reference document    | 808-850 | Configured per-instance               |
...
| Architecture          | 22-65   | File structure, TagRegistry, role sets       |
...
| Section                          | Lines   | Key Topics                                               |
| -------------------------------- | ------- | -------------------------------------------------------- |
| Getting Started                  | 9-67    | Opt-in marker, TS/Gherkin examples, role sets, ownership |
...
| Source            | Owns                                                      | Tags                                       |
| ----------------- | --------------------------------------------------------- | ------------------------------------------ |
| **Feature files** | Canonical pattern identity, lifecycle, executable linkage | `@*-pattern`, `@*-status`, `@*-implements` |
| **TypeScript**    | Additive implementation metadata and shape extraction     | `@*-uses`, `@*-role`, `@*-shape`           |
