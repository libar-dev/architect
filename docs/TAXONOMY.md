...
For backward compatibility, these legacy values are accepted and normalized:
...
```typescript
import { ACCEPTED_STATUS_VALUES } from "@libar-dev/delivery-process/taxonomy";
// ["roadmap", "active", "completed", "deferred", "implemented", "partial", "in-progress"]
```
